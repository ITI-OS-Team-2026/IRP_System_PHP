    ...
    <main class="flex-1 p-5 lg:p-8 space-y-6">
        ...
        <section class="bg-white border-2 border-indigo-900 rounded-lg p-6">
            <?php if (!empty($submission['certificate_number'])): ?>
                <div class="flex flex-wrap items-center justify-between gap-4">
                    <div>
                        ...
                        <p class="text-slate-700 mt-1">تاريخ الإصدار: <span class="font-bold"><?= htmlspecialchars($submission['issued_at'] ? date('Y/m/d', strtotime($submission['issued_at'])) : '-', ENT_QUOTES, 'UTF-8') ?></span></p>
                    </div>
            ...
            <?php else: ?>
                ...
                <p class="text-slate-700 mb-5">عند التأكيد سيتم إنشاء شهادة اعتماد نهائية لهذا البحث.</p>
                <form method="POST">
